...
extends ScreenShot {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            test.driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/ul/li/div/div/button[1]")).click();
            Thread.sleep(2000);
            ...
            if (cartCount.equals("2")) {
                System.out.println("PASS: Decrease games successfully added to cart.");
            } else {
                System.out.println("FAIL: Decrease games not added to cart.");
                test.takeScreenshot("TC_084_Failed");
            }
